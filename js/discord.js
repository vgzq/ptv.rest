...
async function fetchLanyardData() {
    const response = await fetch(`https://api.lanyard.rest/v1/users/1048691978285621268`);
...
function updateProfilePicture(discord_user) {
    ...
    const newProfilePictureSrc = `https://cdn.discordapp.com/avatars/1048691978285621268/${discord_user.avatar}.png`;
